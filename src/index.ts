...
// 活动类型
type ActivityType = "sleep" | "meal" | "exercise" | "mood" | "work" | "hobby" | "health" | "custom";
...
// 解析日志文件中的活动列表
async function parseLogActivities(logPath: string): Promise<ActivityLog[]> {
  try {
...
export default definePluginEntry({
  ...
  register(api) {
    const config = api.pluginConfig as LoggerConfig | undefined;
